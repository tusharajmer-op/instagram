          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Flexible(flex:2,child: Mybuttons(texts: "forgot password?", func: root.signup,bclr:Colors.white, clr: Colors.black,)),
                Flexible(flex : 1,child: Mybuttons(texts: "login", func:root.signup,),),
              ],
            )
